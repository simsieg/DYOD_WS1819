...
// Dictionary is a segment type that stores all its unique (!) values in a vector (the dictionary) and keeps
// only the indexes into the dictionary in the attribute vector
template <typename T>
